...
- [Add a create Listing API]({% link _chapters/add-a-create-listing-api.md %})
- [Add a get Listing API]({% link _chapters/add-a-get-listing-api.md %})
- [Add a list all the Listings API]({% link _chapters/add-a-list-all-the-Listings-api.md %})
- [Add an update Listing API]({% link _chapters/add-an-update-listing-api.md %})
- [Add a delete Listing API]({% link _chapters/add-a-delete-listing-api.md %})
...
- [List all the Listings]({% link _chapters/list-all-the-listings.md %})
