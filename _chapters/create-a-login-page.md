...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Create a new file `src/containers/Login.js` and add the following.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Let's add a couple of styles to this in the file `src/containers/Login.css`.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Now we link this container up with the rest of our app by adding the following line to `src/Routes.js` below our home `<Route>`.
...
![Login page added screenshot]({{ site.baseurl }}/assets/react/login-page-added.png)
