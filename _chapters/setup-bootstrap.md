...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />React Bootstrap uses the standard Bootstrap v3 styles; so just add the following styles to your `public/index.html`.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />To do that, let's add the following to our `src/index.css`.
