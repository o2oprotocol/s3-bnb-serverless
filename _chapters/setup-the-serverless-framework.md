...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Create a directory for our API backend.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Install Serverless globally.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />At the root of the project; create an AWS Node.js service.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Next, install these two packages.
