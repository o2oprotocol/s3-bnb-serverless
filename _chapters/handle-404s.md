...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Create a new component at `src/containers/NotFound.js` and add the following.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Let's add a couple of styles for it in `src/containers/NotFound.css`.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Find the `<Switch>` block in `src/Routes.js` and add it as the last line in that section.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />And include the `NotFound` component in the header by adding the following:
...
![Router 404 page screenshot]({{ site.baseurl }}/assets/react/router-404-page.png)
