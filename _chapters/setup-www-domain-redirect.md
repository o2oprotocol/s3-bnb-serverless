...
![Create S3 Redirect Bucket screenshot]({{ site.baseurl }}/assets/s3-bucket/create-s3-redirect-bucket.png)

Next just follow through the steps and leave the defaults intact.

![Use defaults to create S3 redirect bucket screenshot]({{ site.baseurl }}/assets/s3-bucket/use-defaults-to-create-bucket.png)
...
![Select redirect requests screenshot]({{ site.baseurl }}/assets/s3-bucket/select-redirect-requests.png)
...
![Set origin domain name screenshot]({{ site.baseurl }}/assets/s3-bucket/select-redirect-requests.png)
...
![Fill in record set detials screenshot]({{ site.baseurl }}/assets/deploy-frontend/fill-in-record-set-details.png)
...
![Fill in AAAA IPv6 record set details screenshot]({{ site.baseurl }}/assets/deploy-frontend/fill-in-aaaa-ipv6-record-set-details.png)
