...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Replace our `handleDelete` method in `src/containers/Notes.js`.
...
![Note page deleting screenshot]({{ site.baseurl }}/assets/note-page-deleting.png)
...
![Note page logged out error screenshot]({{ site.baseurl }}/assets/note-page-logged-out-error.png)
