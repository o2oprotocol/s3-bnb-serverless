...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Add the following to `src/components/AsyncComponent.js`.
...
<img class="code-marker" src="{{ site.baseurl }}/assets/s.png" />Your `src/Routes.js` should look like this after the changes.
...
![Create React App Code Splitting build screenshot]({{ site.baseurl }}/assets/react/create-react-app-code-splitting-build.png)
...
Now if we deploy our app using `npm run deploy`; you can see the browser load the different chunks on-demand as we browse around in the [demo](https://serverless-devops.o2oprotocol.io). 

![Create React App loading Code Splitting screenshot]({{ site.baseurl }}/assets/react/create-react-app-loading-code-splitting.png)
